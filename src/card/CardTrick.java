 ...
 * @author srinivsi
 * Modified By:- Ansh Grover
 * Student Number:- 991718101
 * Date:- 31-01-2024
 */
public class CardTrick {
    ...
    public static void main(String[] args) {
        ...
        int CardValueGivenByUser = scanner.nextInt();
        ...
        for (Card card : magicHand) {
            if (card.getValue() == CardValueGivenByUser && card.getSuit().equals(Card.SUITS[userCardSuitIndex])) {
                found = true;
                break;
            }
        }
